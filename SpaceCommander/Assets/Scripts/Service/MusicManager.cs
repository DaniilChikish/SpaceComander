...
namespace SpaceCommander.Service
{
    ...
    public class MusicManager : MonoBehaviour
    {
        ...
        //[Tooltip("Stream audioclip when load from resources")]
        //public bool streamed = true;
        ...
        //public int LoadClipsFromResources(string path)
        //{
        //    DirectoryInfo di = new DirectoryInfo(Application.streamingAssetsPath + "/" + path);
        ...
        //    {
        //        www = new WWW("file:///" + Application.streamingAssetsPath +  "/" + path + "/" + UserFiles[0].Name);
        //        clip = www.GetAudioClip(false, false, AudioType.OGGVORBIS);
        //        if (!playList.Contains(clip))
        //        {
        //            count++;
        //            playList.Add(clip);/*[/url]*/
        //        }
        //    }
        //    return count;
        //}
        ...
        void Start()
        {
            ...
            {
                LoadClipsFromResources("UserMusic");
            }
            Rewind();
            if (playOnAwake)
            {
